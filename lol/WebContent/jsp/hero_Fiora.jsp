		...
		<div class="layout mainer">
			<div id="Navi" class="navi">
				<i class="commspr commico-crumbs"></i> <a
					...
					class="commspr commico-rrow"></i> <span id="DATAnametitle">无双剑姬
					菲奥娜</span>
			</div>

			<div class="infodefail">
				<div id="defailDATA" class="defail-data">
					<h1 id="DATAname">无双剑姬</h1>
					<h2 id="DATAtitle">菲奥娜</h2>
					<div id="DATAtags" class="defail-tags">
						<span>战士</span><span>刺客</span>
					</div>
					...
					<dl id="DATAinfo" class="defail-stat">
						<dt>物理攻击</dt>
						<dd>
							<i class="up up1" title="10" style="width: 100%"></i>
						</dd>
						<dt>魔法攻击</dt>
						<dd>
							<i class="up up2" title="2" style="width: 20%"></i>
						</dd>
						<dt>防御能力</dt>
						<dd>
						...
						<dt>上手难度</dt>
						<dd>
							<i class="up up4" title="3" style="width: 30%"></i>
						</dd>
					</dl>
				...
				<div class="defail-skin">
					<ul id="skinBG" class="defail-skin-bg" style="left: -7440px;">
						<li title="默认皮肤"><img
							src="<%=path %>/images/hero/Fiora/big114000.jpg"
							alt="默认皮肤"></li>
						<li title="皇家守卫 菲奥娜"><img
							src="<%=path %>/images/hero/Fiora/big114001.jpg"
							alt="皇家守卫 菲奥娜"></li>
						<li title="夜鸦 菲奥娜"><img
							src="<%=path %>/images/hero/Fiora/big114002.jpg"
							alt="夜鸦 菲奥娜"></li>
						<li title="女校长 菲奥娜"><img
							src="<%=path %>/images/hero/Fiora/big114003.jpg"
							alt="女校长 菲奥娜"></li>
						<li title="源计划：火 菲奥娜"><img
							src="<%=path %>/images/hero/Fiora/big114004.jpg"
							alt="源计划：火 菲奥娜"></li>
						<li title="泳池派对 菲奥娜"><img
							src="<%=path %>/images/hero/Fiora/big114005.jpg"
							alt="泳池派对 菲奥娜"></li>
						<li title="玉剑传说 无双"><img
							src="<%=path %>/images/hero/Fiora/big114022.jpg"
							alt="玉剑传说 无双"></li>
					</ul>
					<div class="defail-skin-nav">
						<div class="defail-skin-name">
							<span id="skinName">泳池派对 菲奥娜</span>
						</div>
						<ul id="skinNAV">
							<li rel="_0" class=""><a title="默认皮肤"><img
									src="<%=path %>/images/hero/Fiora/small114000.jpg"
									alt="默认皮肤" height="60" width="60"><span class="sbor"></span></a></li>
							<li rel="_1" class=""><a title="皇家守卫 菲奥娜"><img
									src="<%=path %>/images/hero/Fiora/small114001.jpg"
									alt="皇家守卫 菲奥娜" height="60" width="60"><span class="sbor"></span></a></li>
							<li rel="_2" class=""><a title="夜鸦 菲奥娜"><img
									src="<%=path %>/images/hero/Fiora/small114002.jpg"
									alt="夜鸦 菲奥娜" height="60" width="60"><span class="sbor"></span></a></li>
							<li rel="_3" class=""><a title="女校长 菲奥娜"><img
									src="<%=path %>/images/hero/Fiora/small114003.jpg"
									alt="女校长 菲奥娜" height="60" width="60"><span class="sbor"></span></a></li>
							<li rel="_4" class=""><a title="源计划：火 菲奥娜"><img
									src="<%=path %>/images/hero/Fiora/small114004.jpg"
									alt="源计划：火 菲奥娜" height="60" width="60"><span class="sbor"></span></a></li>
							<li rel="_5" class="current"><a title="泳池派对 菲奥娜"><img
									src="<%=path %>/images/hero/Fiora/small114005.jpg"
									alt="泳池派对 菲奥娜" height="60" width="60"><span class="sbor"></span></a></li>
							<li rel="_6" class=""><a title="玉剑传说 无双"><img
									src="<%=path %>/images/hero/Fiora/small114022.jpg"
									alt="玉剑传说 无双" height="60" width="60"><span class="sbor"></span></a></li>
						</ul>
					</div>
				</div>
			...
			<div class="clearfix">
				<div class="infoleftcont">
					...
					<div class="colbox bgstroy">
						<div id="DATAlore">菲奥娜是全瓦洛兰最可怕的决斗家。她以雷厉风行、狡黠聪慧闻名于世，同样著名的还有她舞弄自己蓝钢佩剑
							的矫健。菲奥娜出生在德玛西亚王国的劳伦特家族，她从父亲的手中接管了家业，并在一场丑闻风波中将家族拯救于于灭亡的边缘。虽然劳伦特家威严不再，但菲奥
							娜却一直在不懈地努力，希望重振家族荣耀，让劳伦特这个名字重回德玛西亚名望贵族之列。</div>
					...
					<ul id="DATAspellsNAV" class="infotab">
						<li class="current"><img
							src="<%=path %>/images/hero/Fiora/Fiora_P.png"
							alt=""></li>
						<li class=""><img
							src="<%=path %>/images/hero/Fiora/FioraQ.png"
							alt=""></li>
						<li class=""><img
							src="<%=path %>/images/hero/Fiora/FioraW.png"
							alt=""></li>
						<li class=""><img
							src="<%=path %>/images/hero/Fiora/FioraE.png"
							alt=""></li>
						<li class=""><img
							src="<%=path %>/images/hero/Fiora/FioraR.png"
							alt=""></li>
					</ul>
					<div id="DATAspells" class="colbox infoskillbox">
						...
						<p class="skilltip">菲奥娜对附近一名敌方英雄发起挑战，并发现其身上的一处破绽。如果她成功击中该破绽，她会得到额外奖励，并会发现下一处破绽。</p>
					</div>
					...
					<div id="jSearchItemDiv" class="colbox infospells">
						...
						<dl id="infospellsTABclassBlocks" style="display: none;">
							...
							<dd class="borlineX">
								<img data-title="1055"
									src="<%=path %>/images/goods/1055.png"
									alt="" class=""><img data-title="2003"
									src="<%=path %>/images/goods/2003.png"
									alt="" class=""><img data-title="3340"
							...
							<dd class="borlineX">
								<img data-title="3111"
									src="<%=path %>/images/goods/3111.png"
									alt="" class=""><img data-title="3074"
									src="<%=path %>/images/goods/3074.png"
									alt="" class=""><img data-title="3071"
									src="<%=path %>/images/goods/3071.png"
									alt="">
							</dd>
							<dt>进攻型物品</dt>
							<dd class="borlineX">
								<img data-title="3812"
									src="<%=path %>/images/goods/3812.png"
									alt="" class=""><img data-title="3072"
									src="<%=path %>/images/goods/3072.png"
									alt="" class=""><img data-title="3156"
									src="<%=path %>/images/goods/3156.png"
									alt="" class="">
							</dd>
						</dl>
						<dl id="infospellsTABaramBlocks" style="display: block;">
							...
							<dd class="">
								<img data-title="3077"
									src="<%=path %>/images/goods/3077.png"
							...
							<dd class="borlineX">
								<img data-title="3074"
									...
									src="<%=path %>/images/goods/3047.png"
									alt=""><img data-title="3071"
									src="<%=path %>/images/goods/3071.png"
									alt="">
							</dd>
							<dt>进攻型物品</dt>
							...
							<dd class="">
								<img data-title="3053"
									src="<%=path %>/images/goods/3053.png"
									alt=""><img data-title="3161"
									src="<%=path %>/images/goods/3161.png"
									alt=""><img data-title="3065"
									src="<%=path %>/images/goods/3065.png"
									alt="">
							</dd>
						</dl>
					</div>
...
<script type="text/javascript">
	var flashvars={
		p:0,
		e:1,
		i:'<%=path %>/videos/Fiora.JPG'
		};
	var video=['<%=path %>/videos/Fiora.mp4->video/mp4'];
	var support=['all'];
